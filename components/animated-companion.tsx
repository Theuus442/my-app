...
const styles = StyleSheet.create({
  ...
  companion: {
    ...
    alignItems: 'center',
    position: 'relative',
    ...(Platform.OS === 'web' ? { boxShadow: '0 16px 24px rgba(0, 0, 0, 0.2)' } : {
      shadowColor: '#000',
  ...
  eye: {
    ...
    alignItems: 'center',
    borderRadius: 9999,
    ...(Platform.OS === 'web' ? { boxShadow: '0 3px 4px rgba(0, 0, 0, 0.1)' } : {
      shadowColor: '#000',
  ...
  sparkle: {
    ...
    borderRadius: 9999,
    ...(Platform.OS === 'web' ? { boxShadow: '0 0 6px rgba(255, 215, 0, 0.6)' } : {
      shadowColor: '#FFD700',
